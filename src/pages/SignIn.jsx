...
import SplineScene from "../components/SplineScene"; // ✅ original SplineScene
...
export default function SignUpPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex-grow flex items-center justify-center px-6 mt-20">
        <motion.div
